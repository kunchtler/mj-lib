...
} from "../simulation/Default3DModels";
...
import { TableSpot, TableUnknownSpot } from "./TableSpot";
...
export type BasicJugglerParams = {
    name: string;
    juggler?: {
    ...
    leftHandRef?: RefObject<THREE.Object3D> | ((elem: THREE.Object3D) => void);
    rightHandRef?: RefObject<THREE.Object3D> | ((elem: THREE.Object3D) => void);
} & FiberObject3D;
    ...
    return (
        <Juggler name={name} {...props}>
            ...
            <Hand
                ...
                ref={(elem) => {
                    if (leftHandRef !== undefined && elem !== null) {
            ...
            <Hand
                ...
                ref={(elem) => {
                    if (rightHandRef !== undefined && elem !== null) {
