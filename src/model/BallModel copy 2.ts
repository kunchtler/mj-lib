...
export class BallModel {
    ...
    positionAtEvent(evTime: number | null, ev: BallEvent | null): Vector3 | null {
        if (evTime === null || ev === null) {
            return null;
        } else if (ev.transition.type === "airborne") {
            ...
            if (prevEv === null) {
                ...
                // where the ball is.
                const spotModel = handModel.getSpotModel(prevEv.handPosIdx);
            ...
            const spotModel = handModel.getSpotModel(ev.handPosIdx);
    ...
    positionAtTime(time: number): Vector3 {
        ...
        if (prevEv === null) {
            ...
            if (nextEv === null) {
                ...
                const spotModel = handModel.getSpotModel(nextEv.handPosIdx);
            ...
            const prevEvSpotModel = handModel.getSpotModel(prevEv.handPosIdx);
            const nextEvSpotIdx =
                nextEv !== null && nextEv.type === "held" ? nextEv.handPosIdx : prevEv.handPosIdx;
